...
# Service Registry
services = {
    "user": ["http://127.0.0.1:14001/user"],
    "product": ["http://127.0.0.1:15000/product"]
}
...
def main(argv: list):
    ...
    app.run(host='0.0.0.0', debug=True, port=iscs_service_port, threaded=True, use_reloader=False)
